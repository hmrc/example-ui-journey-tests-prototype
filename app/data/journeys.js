module.exports = [
  // this file is in /assets so changes won't trigger destructive reload

  {
    ...
    steps: [
      ...
      { url: "/date", question: "When were you born?", field: "date-of-birth" },
      {
        url: "/checkboxes",
      ...
      },
      {
        ...
        answers: [
          ...
          {
            field: "relaxing-part-of-day",
            label: "Most relaxing part of your day",
          },
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        url: "/warning-text",
        warning:
          "You must provide accurate information or your application will be rejected.",
      },
      {
